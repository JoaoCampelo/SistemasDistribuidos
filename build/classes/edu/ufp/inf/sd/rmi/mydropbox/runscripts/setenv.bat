...
@Set JDK=C:\Program Files\Java\jdk1.8.0_111\bin
...
@Set PACKAGE=mydropbox
@Set PACKAGE_PREFIX=edu.ufp.inf.sd.rmi
@Set PACKAGE_PREFIX_FOLDERS=edu/ufp/inf/sd/rmi
@Set SERVICE_NAME_ON_REGISTRY=MyDropboxService
@Set CLIENT_CLASS_PREFIX=MyDropbox
@Set SERVER_CLASS_PREFIX=MyDropbox
